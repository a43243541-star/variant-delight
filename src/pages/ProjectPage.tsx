...
export const projectsData = [
  {
    ...
    fullDescription: `Школа молодого юриста — флагманский образовательный проект Штаба выпускников СГЮА, направленный на подготовку студентов к реальной юридической практике.
...
Проект разрушает барьеры между поколениями юристов и создаёт атмосферу открытого профессионального диалога, где каждый голос важен.`,
  ...
  },
  {
    ...
    shortDesc: "Практикум по визуализации правовых документов: учимся делать юридические тексты понятными, современными и убедительными.",
    accent: "from-primary/20 to-primary/5",
    fullDescription: `Юридическое проектирование — инновационный проект, объединяющий юриспруденцию и дизайн-мышление для создания понятных правовых документов.

Направления работы:
• Legal Design — визуализация юридических документов
• Разработка понятных договоров и соглашений
• Создание инфографики по правовым процессам
• UX-подход к юридическим услугам
• Проектирование клиентского пути в юридических фирмах

Участники учатся превращать сложные юридические тексты в доступные и визуально привлекательные документы, что становится всё более востребованным навыком на рынке.`,
    highlights: [
      "15 практических воркшопов",
      "100+ редизайнов документов",
      "Партнёрство с дизайн-студиями",
