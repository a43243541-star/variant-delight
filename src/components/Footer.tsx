    ...
    <footer ref={ref} id="footer" className={`bg-deep text-deep-foreground pt-20 pb-8 relative overflow-hidden scroll-reveal ${isVisible ? "visible" : ""}`}>
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid sm:grid-cols-1 lg:grid-cols-[2fr_1fr_1.5fr] gap-10 mb-16">
          ...
          <div>
            ...
            <ul className="list-none space-y-3">
              {[{ label: "О штабе", href: "#about" }, { label: "Об Ассоциации", href: "#history" }, { label: "Фотографии", href: "#gallery" }].map((l) =>
                <li key={l.href}>
                  <button
          ...
          <div>
            ...
            <p className="text-primary-foreground/70 text-base mb-4 leading-relaxed">Не пропусти старт новых обучений и встреч с именитыми выпускниками</p>
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 mb-6 text-sm">
          <Link to="/privacy" className="text-primary-foreground/60 hover:text-primary-foreground transition-colors no-underline">Политика конфиденциальности</Link>
          <Link to="/consent" className="text-primary-foreground/60 hover:text-primary-foreground transition-colors no-underline">Согласие на обработку данных</Link>
          <Link to="/cookies" className="text-primary-foreground/60 hover:text-primary-foreground transition-colors no-underline">Cookies</Link>
        </div>
