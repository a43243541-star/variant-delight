...
const mentors = [
  {
    ...
    role: "Прокурор отдела по надзору за соблюдением законов",
    experience: "12 лет",
    quote: "Помогу выстроить стратегию перехода из in-house в консалтинг.",
    available: true,
  },
  {
    name: "Артин Василий",
  ...
  {
    name: "Петров Дмитрий",
    img: "/lovable-uploads/aaeee28c-0b55-4309-8d8d-ed9703171384.png",
    specialty: "Гражданское право",
    category: "civil",
    role: "Судья, к.ю.н.",
    experience: "18 лет",
    quote: "Поделюсь опытом работы в судебной системе и помогу с научной карьерой.",
    available: true,
  },
];
