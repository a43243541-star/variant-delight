...
},
{
  ...
  category: "civil",
  role: "Медиатор, адвокат по семейным делам, член коллегии адвокатов Саратовской области, выпускник 2006 года",
  experience: "20 лет",
  quote: "Научу вести сложные семейные дела с эмпатией и профессионализмом.",
  available: true
},
{
