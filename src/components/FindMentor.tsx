...
{
  name: "Черников Андрей",
  img: "/placeholder.svg",
  specialty: "Конституционное право",
  category: "prosecution",
  role: "Доцент кафедры конституционного права, эксперт Общественной палаты, кандидат юридических наук, выпускник 1995 года",
  experience: "31 год",
  quote: "Помогу понять механизмы защиты прав человека и конституционного правосудия.",
  available: true
}];
