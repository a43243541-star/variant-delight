...
const History = () => {
  ...
  return (
    <section ref={revealRef} id="history" className={`py-16 lg:py-20 bg-deep text-deep-foreground relative overflow-hidden scroll-reveal ${isVisible ? "visible" : ""}`}>
      <div className="container mx-auto text-center">
        <p className="font-handwritten text-xl md:text-2xl mb-2 text-destructive">Наследие</p>
