    ...
    <div className="container mx-auto">
      <div className="rounded-3xl p-8 md:p-12 lg:p-16 text-primary-foreground grid lg:grid-cols-2 gap-10 items-center relative overflow-hidden shadow-[0_30px_60px_rgba(0,71,255,0.2)]"
        ...
        <div className="relative h-[300px] hidden md:block">
          <div
              className="reveal-left absolute top-0 left-0 w-[280px] rounded-2xl p-5 border border-white/20 shadow-[0_20px_40px_rgba(0,0,0,0.1)] -rotate-[5deg] z-[2] hover:-translate-y-2 hover:rotate-0 hover:scale-105 hover:z-10 transition-all duration-500"
            ...
            <p className="text-sm text-primary-foreground/80 italic">"Научу строить личный бренд адвоката: стань тем, чье имя уже является защитой."</p>
          </div>

          <div className="reveal-right absolute bottom-0 right-0 w-[280px] rounded-2xl p-5 border border-white/20 shadow-[0_20px_40px_rgba(0,0,0,0.1)] rotate-[5deg] z-[1] hover:-translate-y-2 hover:rotate-0 hover:scale-105 hover:z-10 transition-all duration-500" style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(20px)" }}>
            <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-sm text-primary-foreground/80 italic">"Научу архитектуре личного капитала: от студенческого бюджета до инвестиционного портфеля."</p>
          </div>
        </div>
      </div>
    </div>
