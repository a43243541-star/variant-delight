    ...
    >
      <div className="container mx-auto text-center max-w-3xl">
        ...
        <p className="text-primary-foreground/70 text-lg leading-relaxed mb-10 max-w-xl mx-auto">
          Молодежный штаб Ассоциации выпускников СГЮА — это сообщество амбициозных студентов и молодых юристов.
          Участвуй в проектах, находи наставников и строй карьеру вместе с лучшими.
        </p>
        <a
